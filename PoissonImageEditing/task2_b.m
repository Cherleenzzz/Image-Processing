...
I_result=mixingGradients(I_source,I_background,I1_mask,I2_mask,row_interpolation,col_interpolation,firstpoint);
 
figure;
imshow(I_result),title('Result Image(task2b)');